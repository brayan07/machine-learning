...
def read_header(infile):
    ...
    h['data_type'] = np.fromfile(fid, dtype = np.int16, count = 1)#np.int16
...
def plot_image(path):
    ...
    def animate(i):
        ...
        return [im]
    return matplotlib.animation.FuncAnimation(fig, animate, frames=range(0,data.shape[2]), interval=8, blit=True)
